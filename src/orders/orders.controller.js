...
module.exports={
  ...
  create: [
    ...
    validateDishes,validateDishesQuantity,create],
  read:[validateOrderExists,read],
  update:[validateOrderExists,validateBodyExists,...["deliverTo","mobileNumber","dishes"].map(field=>validateTextExistsFunction(field)),validateDishes,validateDishesQuantity,validateBodyStatus,validateExistingStatus,validateBodyId,update],
  destroy:[
    validateOrderExists,validateIfStatusPending,destroy
  ]  
}