...
module.exports={
  ...
  create: [
    validateBodyExists,
    ...["name","description","price","image_url"].map(field=>validateTextExistsFunction(field)), validatePrice,create],
  read:[validateDishExists,read],
  update:[validateDishExists,validateBodyExists,...["name","description","price","image_url"].map(field=>validateTextExistsFunction(field)),validatePrice,validateBodyId,update]}
